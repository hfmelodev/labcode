...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('px-3 py-2 font-semibold text-muted-foreground text-xs tracking-wider data-inset:pl-9.5', className)}
      {...props}
    />
  )
}
