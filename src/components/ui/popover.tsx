...
function PopoverTitle({ className, ...props }: React.ComponentProps<'h2'>) {
  return <div data-slot="popover-title" className={cn('font-semibold text-xs uppercase', className)} {...props} />
}
